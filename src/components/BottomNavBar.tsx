  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
        {/* Home */}
        <Link to="/" onClick={handleHomeClick} className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-700 group touch-manipulation" style={{ minWidth: '60px', minHeight: '60px' }}>
